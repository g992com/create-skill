#!/usr/bin/env python3
"""
Regression tests for quick_validate.py. Run to verify the validator behaves correctly.
Usage: python test_quick_validate.py   (from scripts/ or with scripts/ on PATH)
"""
