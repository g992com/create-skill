#!/usr/bin/env python3
"""
Regression tests for package_skill.py. Run to verify packaging and security behavior.
Usage: python test_package_skill.py   (from scripts/ or with scripts/ on PATH)
"""
...
# Mock quick_validate so tests focus on packaging (symlinks, escape, etc.)
